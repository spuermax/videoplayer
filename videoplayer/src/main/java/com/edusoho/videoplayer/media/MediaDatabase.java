...
//    public static final int INDEX_MEDIA_LAST_MODIFIED = 18;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public SQLiteDatabase getWritableDatabase() {
            ...
            try {
                ...
                try {
                    db = SQLiteDatabase.openOrCreateDatabase(mContext.getDatabasePath(DB_NAME), null);
    ...
    public static void setPicture(Context context, MediaWrapper m, Bitmap p) {
        Log.d(TAG, "Setting new picture for " + m.getTitle());
        try {
            getInstance(context).updateMedia(
                    m.getUri(),
                    INDEX_MEDIA_PICTURE,
                    p);
