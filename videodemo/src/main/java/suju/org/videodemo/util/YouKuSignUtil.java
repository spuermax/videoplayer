...
public class YouKuSignUtil {
     ...
     */
    public static TreeMap get_sign(TreeMap<String, Object> params, String appKey, String secret)
            throws Exception {
        /**
         * 用于存放与业务参数名相同的系统参数
         */
...
//        System.out.println(signString.toString());
    ...
    private static String md5Sign(String signString)  {
        String sign = DigestUtils.md5(signString);
        return sign;
    }
