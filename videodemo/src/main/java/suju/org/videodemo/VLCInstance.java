...
public class VLCInstance {
    ...
    private static Runnable sCopyLua = new Runnable() {
        ...
        public void run() {
            String destinationFolder = AndroidDevices.EXTERNAL_PUBLIC_DIRECTORY+
                    "/Android/data/"+VideoPlayApplication.application.getPackageName()+"/lua";
            AssetManager am = VideoPlayApplication.application.getAssets();
    ...
    public static void linkCompatLib(Context context) {
        ...
        try {
            is = VideoPlayApplication.application.getAssets().open("libcompat.7.so");
    ...
    public synchronized static LibVLC get() throws IllegalStateException {
        if (sLibVLC == null) {
            ...
            final Context context = VideoPlayApplication.application;
